<script>
  ...
  async function fetchCurrentWeather(param){
    ...
    await fetch(`https://api.weatherapi.com/v1/forecast.json?key=43f8873828754a84b67172205232204&q=${selected_city}&days=1&aqi=yes&alerts=no`, {mode: 'cors'})
  ...
  async function fetchWeatherByHours() {
    ...
    await fetch(`https://api.weatherapi.com/v1/forecast.json?key=43f8873828754a84b67172205232204&q=${selected_city}&days=2&aqi=yes&alerts=no`, {mode: 'cors'})
      .then((resp) => {return resp.json()})
      .then((d) => {
        console.log(d)
        for(let i=0; i<12; i++){
  ...
  async function fetchWeatherForecast5() {
    let forecast = []
    await fetch(`https://api.weatherapi.com/v1/forecast.json?key=43f8873828754a84b67172205232204&q=${selected_city}&days=6&aqi=yes&alerts=no`, {mode: 'cors'})
      .then((resp) => {return resp.json()})
      .then((d) => {
        for(let i=1; i<6; i++){
  ...
  const updateWeather = async() => {
    ...
    await fetch(`https://api.weatherapi.com/v1/current.json?key=43f8873828754a84b67172205232204&q=${selected_city}`, {mode: 'cors'})
      .then((resp) => {
        console.log(resp.ok)
        if(resp.ok){
